...
The safe default for what each shot should *do* is: **shot 1 sells the outcome, shot 2 shows the workflow, shot 3 shows the differentiator**. What that means in practice changes per vertical — compare [fitness app screenshots](/screenshots-for/fitness-apps), where shot 1 has to imply momentum, with [finance app screenshots](/screenshots-for/finance-apps), where shot 1 is one number large enough to read across the room, or [indie game screenshots](/screenshots-for/indie-games), where the genre has to land at thumbnail size before anyone reads a word.
...
Need to ship by tomorrow morning? [Generate three polished shots in under a minute](/sign-up) — no subscription, $7 once. The full breakdown of the three credit packs is on the [ShotStudio pricing page](/pricing), and if you're still shortlisting tools, the [App Store screenshot tool alternatives](/alternatives) index compares AppMockUp, Previewed, Rotato, Shotbot and Screenshots.pro on price and on how much layout work they leave you.
